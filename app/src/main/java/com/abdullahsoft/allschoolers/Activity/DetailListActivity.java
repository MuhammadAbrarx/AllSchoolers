...
import com.abdullahsoft.allschoolers.Activity.dummy.DummyContent;
...
public class DetailListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(DetailDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(DetailDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(DetailListActivity parent,
